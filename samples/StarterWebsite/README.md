...
- `CL.GitHelper`, `CL.Storage`, and `CL.NetUtils` are still part of the broader toolkit shape even though this starter stays focused on presentation and app-owned persistence.
